...
import { reorderProjects, deleteProject } from "@/app/actions/projects";
...
export function SortableProjectList({ initial }: { initial: Project[] }) {
  ...
  function handleDragEnd(event: DragEndEvent) {
    ...
    startTransition(async () => {
      ...
      const { error } = await reorderProjects(items);
      if (error) {
